...
Run as ``python -m castra_spec.subprocess_runner``. The
...
:mod:`castra_spec.syscall_filter` for why seccomp rather than a network
...
def _isolate_network(required: bool) -> Optional[dict[str, Any]]:
    ...
    from castra_spec.syscall_filter import SyscallFilterError, install
