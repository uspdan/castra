...
from castra_spec.subprocess_runner import *  # noqa: F401,F403
from castra_spec.subprocess_runner import main  # noqa: F401

if __name__ == "__main__":  # pragma: no cover — legacy invocation path
    import sys
